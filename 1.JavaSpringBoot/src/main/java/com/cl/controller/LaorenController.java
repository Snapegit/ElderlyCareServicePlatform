...
public class LaorenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		if(u==null || !u.getLaorenmima().equals(MD5Util.md5(password))) {
    ...
    public R register(@RequestBody LaorenEntity laoren){
		...
		laoren.setId(uId);
                laoren.setLaorenmima(MD5Util.md5(laoren.getLaorenmima()));
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setLaorenmima(MD5Util.md5("123456"));
    ...
    public R update(@RequestBody LaorenEntity laoren, HttpServletRequest request){
        //ValidatorUtils.validateEntity(laoren);
	LaorenEntity laorenEntity = laorenService.selectById(laoren.getId());
        if(StringUtils.isNotBlank(laoren.getLaorenmima()) && !laoren.getLaorenmima().equals(laorenEntity.getLaorenmima())) {
                laoren.setLaorenmima(MD5Util.md5(laoren.getLaorenmima()));
        }
