...
public class ZhiyuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		if(u==null || !u.getZhiyuanzhemima().equals(MD5Util.md5(password))) {
    ...
    public R register(@RequestBody ZhiyuanzheEntity zhiyuanzhe){
		...
		zhiyuanzhe.setId(uId);
                zhiyuanzhe.setZhiyuanzhemima(MD5Util.md5(zhiyuanzhe.getZhiyuanzhemima()));
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setZhiyuanzhemima(MD5Util.md5("123456"));
	...
	ZhiyuanzheEntity zhiyuanzheEntity = zhiyuanzheService.selectById(zhiyuanzhe.getId());
        if(StringUtils.isNotBlank(zhiyuanzhe.getZhiyuanzhemima()) && !zhiyuanzhe.getZhiyuanzhemima().equals(zhiyuanzheEntity.getZhiyuanzhemima())) {
                zhiyuanzhe.setZhiyuanzhemima(MD5Util.md5(zhiyuanzhe.getZhiyuanzhemima()));
        }
