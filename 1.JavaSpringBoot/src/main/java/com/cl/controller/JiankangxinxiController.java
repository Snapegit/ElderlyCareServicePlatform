...
public class JiankangxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiankangxinxiEntity jiankangxinxi,
		...
		if(tableName.equals("laoren")) {
			jiankangxinxi.setLaorenzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jianhuren")) {
			jiankangxinxi.setJianhurenzhanghao((String)request.getSession().getAttribute("username"));
		}
