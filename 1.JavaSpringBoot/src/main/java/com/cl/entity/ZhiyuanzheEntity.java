...
public class ZhiyuanzheEntity<T> implements Serializable {
	 ...
	 * 设置：志愿者密码
	 */
	public void setZhiyuanzhemima(String zhiyuanzhemima) {
		this.zhiyuanzhemima = zhiyuanzhemima;
	}
	/**
	 * 获取：志愿者密码
	 */
	public String getZhiyuanzhemima() {
		return zhiyuanzhemima;
	}
	/**
	 * 设置：头像
	 */
