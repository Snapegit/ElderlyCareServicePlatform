		...
		<div class="app-contain">
			<el-form class="userinfo_form" ref="userinfoFormRef" :model="form" label-width="$template2.back.add.form.base.labelWidth">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="老人密码" prop="laorenmima">
							<el-input class="list_inp" v-model="user.laorenmima" readonly placeholder="老人密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="监护人账号" prop="jianhurenzhanghao">
							<el-input class="list_inp" v-model="user.jianhurenzhanghao"  placeholder="监护人账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
