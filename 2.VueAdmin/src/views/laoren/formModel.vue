				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="老人密码" prop="laorenmima">
							<el-input class="list_inp" v-model="form.laorenmima" placeholder="老人密码"
								type="password" :readonly="!isAdd||disabledForm.laorenmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='laorenmima'){
					form.value.laorenmima = row[x];
					disabledForm.value.laorenmima = true;
					continue;
				}
				if(x=='laorenxingming'){
