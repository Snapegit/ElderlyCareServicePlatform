	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">活动时间</div>
					<div  class="info_text" >{{detail.huodongshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">活动区域</div>
					<div  class="info_text" >{{detail.huodongquyu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('huodongxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('huodongxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
