	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">老人密码：</div>
					<input class="list_inp"
					 v-model="registerForm.laorenmima" 
					 placeholder="请输入老人密码"
					 type="password"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">确认老人密码：</div>
					<input class="list_inp" v-model="registerForm.laorenmima2" type="password" placeholder="请输入确认老人密码" />
				</div>
				<div class="list_item">
					<div class="list_label">老人姓名：</div>
					<input class="list_inp"
					 v-model="registerForm.laorenxingming" 
					 placeholder="请输入老人姓名"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.laorenzhanghao)){
			context?.$toolUtil.message(`老人账号不能为空`,'error')
			return false
		}
		if((!registerForm.value.laorenmima)){
			context?.$toolUtil.message(`老人密码不能为空`,'error')
			return false
		}
		if((!registerForm.value.laorenxingming)){
