			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="服务内容" prop="fuwuneirong">
						<editor class="list_editor" :value="form.fuwuneirong" placeholder="请输入服务内容" :readonly="!isAdd||disabledForm.fuwuneirong?true:false"
							@change="(e)=>editorChange(e,'fuwuneirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fuwuneirong = res.data.data.fuwuneirong.replace(reg,'../../../cl3973433/file');
