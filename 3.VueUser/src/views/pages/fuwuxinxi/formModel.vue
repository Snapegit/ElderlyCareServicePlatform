	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">服务类型</div>
					<div  class="info_text" >{{detail.fuwuleixing}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'服务预约')" @click="fuwuyuyueonAcross('服务预约','fuwuyuyue','','','')" type="warning">服务预约</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('fuwuxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('fuwuxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="服务内容" name="first">
				<div v-html="detail.fuwuneirong"></div>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
<script setup>
	...
	const fuwuyuyueonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
