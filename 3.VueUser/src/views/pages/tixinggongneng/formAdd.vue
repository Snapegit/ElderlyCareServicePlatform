	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"80%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="提醒标题" prop="tixingbiaoti">
						<el-input class="list_inp" v-model="form.tixingbiaoti" placeholder="提醒标题"
							 type="text" 							:readonly="!isAdd||disabledForm.tixingbiaoti?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="提醒内容" prop="tixingneirong">
						<el-input v-model="form.tixingneirong" placeholder="提醒内容" type="textarea"
						:readonly="!isAdd||disabledForm.tixingneirong?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	//基础信息
	const tableName = 'tixinggongneng'
	const formName = '提醒功能'
	//基础信息
	const breadList = ref([{
		name: formName
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='tixingbiaoti'){
					form.value.tixingbiaoti = row[x];
					disabledForm.value.tixingbiaoti = true;
					continue;
				}
				if(x=='tixingneirong'){
					form.value.tixingneirong = row[x];
					disabledForm.value.tixingneirong = true;
					continue;
				}
