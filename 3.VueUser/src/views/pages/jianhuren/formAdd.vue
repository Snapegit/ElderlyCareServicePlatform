			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="监护人密码" prop="jianhurenmima">
						<el-input class="list_inp" v-model="form.jianhurenmima" placeholder="监护人密码"
							type="password" :readonly="!isAdd||disabledForm.jianhurenmima?true:false" />
					</el-form-item>
				</el-col>
				<el-col :span="8">
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jianhurenmima'){
					form.value.jianhurenmima = row[x];
					disabledForm.value.jianhurenmima = true;
					continue;
				}
