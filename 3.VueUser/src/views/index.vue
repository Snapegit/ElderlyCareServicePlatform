<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">基于Spring Boot的爱老助老服务平台</div>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'laoren'){
				context?.$toolUtil.storageSet("frontName", res.data.data.laorenzhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'laoren'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'jianhuren'){
				context?.$toolUtil.storageSet("frontName", res.data.data.jianhurenzhanghao)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'jianhuren'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.touxiang)
			}
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'zhiyuanzhe'){
